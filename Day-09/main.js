...
=== Solution ===
*/
const indexOfFirstSixLetterCountry = countries.findIndex(
  (arr) => arr.length === 6
);
// console.log(indexOfFirstSixLetterCountry);
...
=== Solution ===
*/
const positionOfNorway = countries.findIndex((arr) => arr === "Norway");
